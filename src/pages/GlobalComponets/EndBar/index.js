    ...
    <>
      <div className="content">
        <div className="part1 partControllAll">
          <span className="btn_logo_endbar">
            <a href="/">
              <button>
                ...
                <span className="logo_text_logo">
                  <span className="endbar_exatas">
                    <h2>Exatas</h2>
                  </span>
                  <span className="endbar_blog">
                    <h1>Blog</h1>
                  </span>
                </span>
              </button>
          ...
          <span className="endBar_text">
            <p className="color-endbar">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt ad
              hic iste tempora. Consequuntur adipisci iure repellendus odio
              placeat ducimus ipsum, dolore quo! Quod hic accusamus aliquid
              omnis eaque minima!
            </p>
          </span>
          <span className="social_icons_endbar ">
            <a href="">
              <button className="social_btn_icons">
        ...
        <div className="part2 partControllAll">
          <h1>Services</h1>
          <ul>
            <a href="" className="services_link">
              <li>Web Design</li>
            </a>
            <a href="" className="services_link">
              <li>Mobile Design</li>
        ...
        <div className="part4 partControllAll">
          ...
          <span className="endbar_tesktext">
          <textarea name="taskContact" id="" cols="30" rows="10" placeholder="Message:"></textarea>
