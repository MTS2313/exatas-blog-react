...
function MiddleMain() {
    ...
    if (i %2) {
        invert = "flex-direction:row-revert;";
        
    } else{
       invert = "flex-direction:unset;";
    }
    return (
        <>
        ...
        RecentData.map((i) => (
           ...
           <div className="MiddleMain-Text-Link">
               <h1 className="MiddleMainTitle">{i.title}</h1><h2 className="MiddleMainSubTitle">{i.desc}</h2>
                   <a href=""><div className="MiddleMain-Button"><p className="btn-view">View</p><svg width="21" height="15" viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
